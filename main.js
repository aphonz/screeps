...
module.exports.loop = function () {
	...
	if (Game.time % 15 == 0) {
		...
		console.log('claimer: ' + clamimer.length);
		...
		if(harvesters.length === 0) {
			...
			var newName = Game.spawns.Spawn1.createCreep([WORK,CARRY,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY], undefined, {role: 'upgrader', upgradeContainer:'57f0263b7ac830486d65d391'});
			console.log('Spawning new Upgrader: ' + newName);
		}
		else if(repairers.length < 1) {
			var newName = Game.spawns.Spawn1.createCreep([WORK,CARRY,MOVE,MOVE,WORK,WORK,CARRY,MOVE,WORK,CARRY,MOVE], undefined, {role: 'Repairer'});
